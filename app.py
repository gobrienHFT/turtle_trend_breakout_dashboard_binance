...
LEVELS_THREADS = int(os.environ.get("LEVELS_THREADS", "10"))
MAX_TIMING_SYMBOLS = int(os.environ.get("MAX_TIMING_SYMBOLS", "30"))
LEVELS_MAX_SYMBOLS = int(os.environ.get("LEVELS_MAX_SYMBOLS", "60"))
MAX_LEVELS_RUNTIME_SEC = int(os.environ.get("MAX_LEVELS_RUNTIME_SEC", "20"))
...
with st.sidebar:
    ...
    max_symbols_ui = st.slider("Max symbols to scan", min_value=20, max_value=300, value=int(LEVELS_MAX_SYMBOLS), step=10)
